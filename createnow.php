        ...
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active text-white" href="#">
                                <i class="bi bi-book"></i> Book Info
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <!--/* <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3">
                    <h1 class="h4">Upload a File or Merge Multiple Files Here</h1>
                </div> */-->
                <div class="file-upload-area d-flex justify-content-center">
                    <div class="upload-box text-center">
                        <!-- Icons section -->
                        <div class="upload-icons mb-3">
                        ...
                        <!-- Title -->
                        <h2 class="mb-3">Upload a File or Merge Multiple Files Here</h2>
                        <p>File types supported: <span class="text-primary">PDF, PPT, PNG, JPG, Word, WEBP, TIFF</span></p>
                        <p>Maximum size: 100MB</p>

                        <!-- Upload Buttons -->
                        <a class="btn btn-primary btn-lg mb-3" href="./browse.php">Browse Files</a>
                        <p>drag and drop files here or add from</p>
                        
                        <!-- Cloud and Dropbox options -->
                        <!--/* <div class="d-flex justify-content-center">
                            <button class="btn btn-outline-secondary me-2">File/iCloud Link</button>
                            <button class="btn btn-outline-secondary">Dropbox</button>
                        </div> */-->

                        <!-- Additional links -->
                        <!--/* <p class="mt-3">Don't have a file now? <a href="#" class="text-primary">Download a PDF</a></p> */-->
                    </div>
                </div>
            </main>
        </div>
